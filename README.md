...
| **MVP-2** | 真实摄像头画面（Kotlin 原生 + MediaCodec 硬编 + PyAV 硬解） | 🟡 批次 2 ✅ + Phase X ✅ + Phase Y ✅ + 批次 3.1 ✅（2026-06-08 phone_native/ 4 屏完整 + 跨屏状态同步 + 真机验收 5 截图 + H264Encoder 单帧 H.264 验证通过，v0.2.6-mvp2-batch3.1）|
