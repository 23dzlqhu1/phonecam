...
|| WebSocket + H.264 | ❌ 已废弃 | ~~phone/lib/stream_server.dart~~（[已废弃] 2026-06-09 phone/ 整体已 git rm）；`desktop/h264_receiver.py` 已删除 | MVP-2 改为新建 `phone_native/` Kotlin 原生重写为 TCP+PCP |
