...
| **MVP-2** | 真实摄像头画面闭环 | 5-7 天 | 🟡 批次 2 ✅ + Phase X ✅ + Phase Y ✅ + 批次 3.1 ✅ + 批次 3.2.0.1 ✅ 2026-06-08（v0.2.7-mvp2-batch3.2.0.1，H264Encoder 单帧验证 + **EGL 零拷贝渲染验证通过**，G-019 自动消失），下一批次 3.2.0.2（接 Camera2 ImageReader 真实帧）|
